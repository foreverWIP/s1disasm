...
.next:
		move.b	d0,2(a1)
		move.b	#0,3(a1)
		addq.w	#2,v_btnpushtime1
		andi.w	#$3FF,v_btnpushtime1
		rts	
; ===========================================================================

MDemo_On:
		tst.b	v_jpadhold1	; is start button pressed?
		bpl.s	.dontquit	; if not, branch
		tst.w	f_demo	; is this an ending sequence demo?
...
.dontquit:
		...
		moveq	#0,d0
		move.b	v_zone,d0
		cmpi.b	#id_Special,v_gamemode ; is this a special stage?
