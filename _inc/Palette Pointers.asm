...
palp:	macro desinationPaletteLine,sourceAddress,cond
	ifb cond
	dc.l sourceAddress
	dc.l v_palette+desinationPaletteLine*$10*2,(sourceAddress_end-sourceAddress)/4-1
	else
	if cond
	dc.l sourceAddress
	dc.l v_palette+desinationPaletteLine*$10*2,(sourceAddress_end-sourceAddress)/4-1
...
palid_Title:		equ (ptr_Pal_Title-PalPointers)/12
palid_LevelSel:		equ (ptr_Pal_LevelSel-PalPointers)/12
palid_Sonic:		equ (ptr_Pal_Sonic-PalPointers)/12
palid_GHZ:		equ (ptr_Pal_GHZ-PalPointers)/12
palid_LZ:		equ (ptr_Pal_LZ-PalPointers)/12
palid_MZ:		equ (ptr_Pal_MZ-PalPointers)/12
palid_SLZ:		equ (ptr_Pal_SLZ-PalPointers)/12
palid_SYZ:		equ (ptr_Pal_SYZ-PalPointers)/12
palid_SBZ1:		equ (ptr_Pal_SBZ1-PalPointers)/12
palid_Special:		equ (ptr_Pal_Special-PalPointers)/12
palid_LZWater:		equ (ptr_Pal_LZWater-PalPointers)/12
palid_SBZ3:		equ (ptr_Pal_SBZ3-PalPointers)/12
palid_SBZ3Water:	equ (ptr_Pal_SBZ3Water-PalPointers)/12
palid_SBZ2:		equ (ptr_Pal_SBZ2-PalPointers)/12
palid_LZSonWater:	equ (ptr_Pal_LZSonWater-PalPointers)/12
palid_SBZ3SonWat:	equ (ptr_Pal_SBZ3SonWat-PalPointers)/12
palid_SSResult:		equ (ptr_Pal_SSResult-PalPointers)/12
palid_Continue:		equ (ptr_Pal_Continue-PalPointers)/12
palid_Ending:		equ (ptr_Pal_Ending-PalPointers)/12
