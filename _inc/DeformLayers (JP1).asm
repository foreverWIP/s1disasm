...
Deform_GHZ:
	...
	; calculate background scroll	
		move.w	(v_bgscroll_buffer).l,d0
		add.w	(v_bg3screenposx).l,d0
		neg.w	d0
		move.w	#$1F,d1
		sub.w	d4,d1
		bcs.s	.gotoCloud2
	...
	.gotoCloud2:
		move.w	(v_bgscroll_buffer+4).l,d0
		add.w	(v_bg3screenposx).l,d0
		neg.w	d0
		move.w	#$F,d1
	.cloudLoop2:		; middle cloud (16px)
		...
		move.w	(v_bgscroll_buffer+8).l,d0
		add.w	(v_bg3screenposx).l,d0
		neg.w	d0
		move.w	#$F,d1
...
Deform_LZ:
	...
	; plain background scroll
		...
		move.b	(v_lz_deform).l,d2
		move.b	d2,d3
		addi.w	#$80,(v_lz_deform).l

		add.w	(v_bgscreenposy).l,d2
		andi.w	#$FF,d2
		add.w	(v_screenposy).l,d3
		andi.w	#$FF,d3
		lea	(v_hscrolltablebuffer).l,a1
		move.w	#$DF,d1
		move.w	(v_screenposx).l,d0
		...
		neg.w	d0
		move.w	(v_waterpos1).l,d4
		move.w	(v_screenposy).l,d5
...
Deform_MZ:
	...
	.noYscroll:
		...
		move.w	d0,(v_bg3screenposy).l
		bsr.w	BGScroll_YAbsolute
		move.w	(v_bgscreenposy).l,(v_bgscrposy_vdp).l
	; do something with redraw flags
		move.b	(v_bg1_scroll_flags).l,d0
		or.b	(v_bg2_scroll_flags).l,d0
		or.b	d0,(v_bg3_scroll_flags).l
		clr.b	(v_bg1_scroll_flags).l
		clr.b	(v_bg2_scroll_flags).l
...
Deform_SBZ:
	...
	; vertical scrolling
		...
		move.w	d0,(v_bgscrposy_vdp).l
		move.b	(v_bg1_scroll_flags).l,d0
		or.b	(v_bg3_scroll_flags).l,d0
		or.b	d0,(v_bg2_scroll_flags).l
		clr.b	(v_bg1_scroll_flags).l
		clr.b	(v_bg3_scroll_flags).l
	; calculate background scroll buffer
		lea	(v_bgscroll_buffer).l,a1
		move.w	(v_screenposx).l,d2
		neg.w	d2
...
Bg_Scroll_Y:
		...
		sub.l	d3,d0
		bpl.s	.scrollBottom
		bset	#4,(v_bg1_scroll_flags).l
		rts
	.scrollBottom:
		bset	#5,(v_bg1_scroll_flags).l
	.return:
		rts
...
BGScroll_Block2:
		move.l	(v_bg2screenposx).l,d2
		move.l	d2,d0
		add.l	d4,d0
		move.l	d0,(v_bg2screenposx).l
		move.l	d0,d1
		swap	d1
		andi.w	#$10,d1
		move.b	(v_bg2_xblock).l,d3
		eor.b	d3,d1
		bne.s	.return
		eori.b	#$10,(v_bg2_xblock).l
		sub.l	d2,d0
		bpl.s	.scrollRight
		bset	d6,(v_bg2_scroll_flags).l
		bra.s	.return
	.scrollRight:
		addq.b	#1,d6
		bset	d6,(v_bg2_scroll_flags).l
...
;-------------------------------------------------------------------------------
BGScroll_Block3:
		move.l	(v_bg3screenposx).l,d2
		move.l	d2,d0
		add.l	d4,d0
		move.l	d0,(v_bg3screenposx).l
		move.l	d0,d1
		swap	d1
		andi.w	#$10,d1
		move.b	(v_bg3_xblock).l,d3
		eor.b	d3,d1
		bne.s	.return
		eori.b	#$10,(v_bg3_xblock).l
		sub.l	d2,d0
		bpl.s	.scrollRight
		bset	d6,(v_bg3_scroll_flags).l
		bra.s	.return
	.scrollRight:
		addq.b	#1,d6
		bset	d6,(v_bg3_scroll_flags).l
