...
ptr_musend: equ SoundIndex
	...
	declsndid ptr_sndCE
	declsndid ptr_sndCF
SpecSoundIndex: equ $D0
ptr_sndend: equ SpecSoundIndex
	declsndid ptr_sndD0
cursndid := $E0
Sound_ExIndex: equ $E0
ptr_specend: equ Sound_ExIndex
	declsndid ptr_flgE0
	declsndid ptr_flgE1
	declsndid ptr_flgE2
	declsndid ptr_flgE3
