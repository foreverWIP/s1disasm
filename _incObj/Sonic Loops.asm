...
Sonic_Loops:
		cmpi.b	#id_SLZ,v_zone ; is level SLZ ?
		beq.s	.isstarlight	; if yes, branch
		tst.b	v_zone	; is level GHZ ?
...
.isstarlight:
		...
		cmp.b	v_256roll1,d1 ; is Sonic on a "roll tunnel" tile?
		beq.w	Sonic_ChkRoll	; if yes, branch
		cmp.b	v_256roll2,d1
		beq.w	Sonic_ChkRoll

		cmp.b	v_256loop1,d1 ; is Sonic on a loop tile?
