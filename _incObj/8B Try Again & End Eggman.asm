...
EEgg_Main:	; Routine 0
		...
		move.b	#id_CreditsText,v_tryagain ; load credits object
		move.w	#9,v_creditsnum ; use "TRY AGAIN" text
		move.b	#id_TryChaos,v_eggmanchaos ; load emeralds object on "TRY AGAIN" screen
...
.noflip:
		lea	v_eggmanchaos,a1 ; get RAM address for emeralds
		moveq	#5,d1
