...
ECha_Main:	; Routine 0
		cmpi.b	#2,v_player+obFrame ; this isn't `fr_Wait1`: `v_player` is Object 88, which has its own frames
...
ECha_CreateEms:
		move.w	v_player+obX,obX(a0) ; match X position with Sonic
		move.w	v_player+obY,obY(a0) ; match Y position with Sonic
		movea.l	a0,a1
		moveq	#0,d3
		moveq	#1,d2
		moveq	#5,d1
