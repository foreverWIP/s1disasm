...
ESon_MakeEmeralds:
		...
		addq.b	#2,ob2ndRout(a0)
		move.w	#1,obAnim(a0)
		move.b	#id_EndChaos,v_endemeralds ; load chaos emeralds objects
...
Obj87_LookUp:	; Routine 6
		...
		bne.s	locret_5480
		move.w	#1,f_restart ; set level to	restart	(causes	flash)
...
Obj87_MakeLogo:	; Routine $C
		...
		move.b	#2,obAnim(a0)
		move.b	#id_EndSTH,v_endlogo ; load "SONIC THE HEDGEHOG" object
