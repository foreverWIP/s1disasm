...
Plat_Main:	; Routine 0
		...
		cmpi.b	#id_SYZ,v_zone ; check if level is SYZ
		bne.s	.notSYZ
...
.notSYZ:
		cmpi.b	#id_SLZ,v_zone ; check if level is SLZ
		bne.s	.notSLZ
...
.type0C:
		...
		move.b	v_oscillate+$E,d1 ; load platform-motion variable
		neg.b	d1		; reverse platform-motion
		addi.b	#$30,d1
		bra.s	.type02_move
; ===========================================================================
...
.type07:
		...
		lea	f_switch,a2	; load switch statuses
		moveq	#0,d0
...
.chgmotion:
		move.b	v_oscillate+$1A,objoff_26(a0) ; update platform-movement variable
		rts	
; ===========================================================================
