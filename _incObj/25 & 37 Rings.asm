...
Ring_Animate:	; Routine 2
		move.b	v_ani1_frame,obFrame(a0) ; set frame
		bsr.w	DisplaySprite
...
CollectRing:
		addq.w	#1,v_rings	; add 1 to rings
		ori.b	#1,f_ringcount ; update the rings counter
		move.w	#sfx_Ring,d0	; play ring sound
		cmpi.w	#100,v_rings ; do you have < 100 rings?
		blo.s	.playsnd	; if yes, branch
		bset	#1,v_lifecount ; update lives counter
		beq.s	.got100
		cmpi.w	#200,v_rings ; do you have < 200 rings?
		blo.s	.playsnd	; if yes, branch
		bset	#2,v_lifecount ; update lives counter
		bne.s	.playsnd
...
RLoss_Count:	; Routine 0
		movea.l	a0,a1
		moveq	#0,d5
		move.w	v_rings,d5	; check number of rings you have
		moveq	#32,d0
