...
Sonic_Move:
		move.w	(v_sonspeedmax).l,d6
		move.w	(v_sonspeedacc).l,d5
		move.w	(v_sonspeeddec).l,d4
		tst.b	(f_slidemode).l
		bne.w	loc_12FEE
		tst.w	objoff_3E(a0)
...
Sonic_LookUp:
		btst	#bitUp,(v_jpadhold2).l ; is up being pressed?
		beq.s	Sonic_Duck	; if not, branch
		move.b	#id_LookUp,obAnim(a0) ; use "looking up" animation
		cmpi.w	#$C8,(v_lookshift).l
		beq.s	loc_12FC2
		addq.w	#2,(v_lookshift).l
		bra.s	loc_12FC2
; ===========================================================================

Sonic_Duck:
		btst	#bitDn,(v_jpadhold2).l ; is down being pressed?
		beq.s	Sonic_ResetScr	; if not, branch
		move.b	#id_Duck,obAnim(a0) ; use "ducking" animation
		cmpi.w	#8,(v_lookshift).l
		beq.s	loc_12FC2
		subq.w	#2,(v_lookshift).l
		bra.s	loc_12FC2
; ===========================================================================

Sonic_ResetScr:
		cmpi.w	#$60,(v_lookshift).l ; is screen in its default position?
		beq.s	loc_12FC2	; if yes, branch
		bcc.s	loc_12FBE
		addq.w	#4,(v_lookshift).l ; move screen back to default

loc_12FBE:
		subq.w	#2,(v_lookshift).l ; move screen back to default
