...
Over_ChgMode:
		tst.b	f_timeover	; is time over flag set?
		bne.s	Over_ResetLvl	; if yes, branch
		move.b	#id_Continue,v_gamemode ; set mode to $14 (continue screen)
		tst.b	v_continues	; do you have any continues?
		bne.s	Over_Display	; if yes, branch
		move.b	#id_Sega,v_gamemode ; set mode to 0 (Sega screen)
		bra.s	Over_Display
; ===========================================================================
