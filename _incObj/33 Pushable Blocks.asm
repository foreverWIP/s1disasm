...
loc_BF6E:	; Routine 2
		...
		move.w	obX(a0),d4
		bsr.w	loc_C186
		cmpi.w	#(id_MZ<<8)+0,v_zone ; is the level MZ act 1?
...
PushB_ChkLava:
		cmpi.w	#(id_MZ<<8)+1,v_zone ; is the level MZ act 2?
...
PushB_ChkLava2:
		cmpi.w	#(id_MZ<<8)+2,v_zone ; is the level MZ act 3?
