...
loc_19F50:
		addq.w	#7,v_random
		cmpi.b	#id_Roll,v_player+obAnim
		bne.s	loc_19F48
		move.w	#$300,d0
		btst	#0,obStatus(a0)
		bne.s	loc_19F6A
...
loc_1A166:
		cmpi.w	#boss_fz_end,v_limitright2
		bge.s	loc_1A172
...
loc_1A216:
		cmpi.w	#boss_fz_end+$90,v_player+obX
		blt.s	loc_1A23A
		move.b	#1,f_lockctrl
		move.w	#0,v_jpadhold2
		clr.w	v_player+obInertia
		tst.w	obVelY(a0)
		bpl.s	loc_1A248
		move.w	#$100,v_jpadhold2

loc_1A23A:
		cmpi.w	#boss_fz_end+$E0,v_player+obX
		blt.s	loc_1A248
		move.w	#boss_fz_end+$E0,v_player+obX
