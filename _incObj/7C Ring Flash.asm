...
Flash_Collect:
		...
		move.b	#id_Null,v_player+obAnim ; make Sonic invisible
		move.b	#1,f_bigring ; stop	Sonic getting bonuses
		clr.b	v_invinc	; remove invincibility
		clr.b	v_shield	; remove shield
...
Flash_End:
		addq.b	#2,obRoutine(a0)
		move.w	#0,v_player ; remove Sonic object
		addq.l	#4,sp
		rts	
