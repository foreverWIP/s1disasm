...
.notducking:
		move.w	#$10,d4
		add.w	d5,d5
		lea	v_lvlobjspace,a1 ; set object RAM start address
...
.breakenemy:
		bset	#7,obStatus(a1)
		moveq	#0,d0
		move.w	v_itembonus,d0
		addq.w	#2,v_itembonus ; add 2 to item bonus counter
		cmpi.w	#6,d0
		blo.s	.bonusokay
...
.bonusokay:
		...
		cmpi.w	#$20,v_itembonus ; have 16 enemies been destroyed?
...
HurtSonic:
		tst.b	v_shield	; does Sonic have a shield?
		bne.s	.hasshield	; if yes, branch
		tst.w	v_rings	; does Sonic have any rings?
...
.hasshield:
		move.b	#0,v_shield	; remove shield
...
.norings:
		tst.w	f_debugmode	; is debug mode	cheat on?
...
KillSonic:
		tst.w	v_debuguse	; is debug mode	active?
		bne.s	.dontdie	; if yes, branch
		move.b	#0,v_invinc	; remove invincibility
