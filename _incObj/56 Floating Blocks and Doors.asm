...
; moves up when a switch is pressed
		tst.b	objoff_38(a0)
		bne.s	.loc_104A4
		cmpi.w	#(id_LZ<<8)+0,v_zone ; is level LZ1 ?
		bne.s	.aaa		; if not, branch
		cmpi.b	#3,fb_type(a0)
		bne.s	.aaa
		clr.b	f_wtunnelallow
		move.w	v_player+obX,d0
		cmp.w	obX(a0),d0
		bhs.s	.aaa
		move.b	#1,f_wtunnelallow
...
.type07:
		tst.b	objoff_38(a0)
		bne.s	.loc_1055E
		tst.b	f_switch+$F	; has switch number $F been pressed?
		beq.s	.locret_10578
		move.b	#1,objoff_38(a0)
		clr.w	fb_height(a0)
...
.type08:
		move.w	#$10,d1
		moveq	#0,d0
		move.b	v_oscillate+$2A,d0
		lsr.w	#1,d0
		move.w	v_oscillate+$2C,d3
		bra.s	.square
; ===========================================================================
...
.type09:
		move.w	#$30,d1
		moveq	#0,d0
		move.b	v_oscillate+$2E,d0
		move.w	v_oscillate+$30,d3
		bra.s	.square
; ===========================================================================
...
.type0A:
		move.w	#$50,d1
		moveq	#0,d0
		move.b	v_oscillate+$32,d0
		move.w	v_oscillate+$34,d3
		bra.s	.square
; ===========================================================================
...
.type0B:
		move.w	#$70,d1
		moveq	#0,d0
		move.b	v_oscillate+$36,d0
		move.w	v_oscillate+$38,d3
