...
GRing_Main:	; Routine 0
		...
		tst.b	obRender(a0)
		bpl.s	GRing_Animate
		cmpi.b	#6,v_emeralds ; do you have 6 emeralds?
...
GRing_Okay:
		...
		move.w	#$C40,v_gfxbigring	; Signal that Art_BigRing should be loaded ($C40 is the size of Art_BigRing)

GRing_Animate:	; Routine 2
		move.b	v_ani1_frame,obFrame(a0)
