...
.chkinvincible:
		...
		moveq	#0,d0
		move.b	v_zone,d0
		cmpi.w	#(id_LZ<<8)+3,v_zone ; check if level is SBZ3
		bne.s	.music
...
.removeinvincible:
		move.b	#0,v_invinc ; cancel invincibility

.chkshoes:
		tst.b	v_shoes	; does Sonic have speed	shoes?
		...
		move.b	#0,v_shoes	; cancel speed shoes
