...
Cred_Main:	; Routine 0
		...
		move.w	v_creditsnum,d0 ; load credits index number
		...
		cmpi.b	#btnABC+btnDn,v_jpadhold1 ; is A+B+C+Down being pressed? ($72)
		bne.s	Cred_Display	; if not, branch
		move.w	#cWhite,v_pal_dry_dup+$40 ; 3rd palette, 1st entry = white
		move.w	#$880,v_pal_dry_dup+$42 ; 3rd palette, 2nd entry = cyan
		jmp	(DeleteObject).l
; ===========================================================================
