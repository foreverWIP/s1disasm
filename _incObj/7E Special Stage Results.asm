...
SSR_Main:
		...
		lea	(SSR_Config).l,a2
		moveq	#3,d1
		cmpi.w	#50,v_rings	; do you have 50 or more rings?
...
loc_C86C:
		...
		move.b	#id_SSRChaos,v_ssresemeralds ; load chaos emerald object
...
SSR_RingBonus:	; Routine 6
		bsr.w	DisplaySprite
		move.b	#1,f_endactbonus ; set ring bonus update flag
...
loc_C8C4:
		...
		addq.b	#2,obRoutine(a0)
		move.w	#180,obTimeFrame(a0) ; set time delay to 3 seconds
		cmpi.w	#50,v_rings	; do you have at least 50 rings?
...
SSR_Continue:	; Routine $E
		move.b	#4,v_ssrescontinue+obFrame
		move.b	#$14,v_ssrescontinue+obRoutine
